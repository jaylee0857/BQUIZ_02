...
INSERT INTO `log` (`id`, `member_id`, `news_id`) VALUES
(5, 1, 4);
...
(7, 'test', '5678', 'test@labor.gov.tw'),
(8, 'mem01', 'mem01', 'mem01@labor.gov.tw'),
(9, 'mem02', 'mem02', 'mem02@labor.gov.tw'),
(10, '11', '11', '11');
...
(2, '11', 3, 1),
(3, '22', 2, 1),
(4, '問題一：你最常做什麼運動來促進健康體能呢?', 1, 0),
(5, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 0, 4),
(6, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 0, 4),
(7, '3.球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 0, 4),
(8, '4.舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 0, 4),
(9, 'ㄏ', 1, 4);
